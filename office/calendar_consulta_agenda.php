...
if (isset($_GET['cancelar_id'])) {
    ...
    if ($conexao->query($sql_cancelar) === TRUE) {
        ...
        echo "Erro ao cancelar o agendamento: " . $conexao->error;
    }
}
...
<form method="GET" action="/projeto_final/office/consulta_agenda.php">
    ...
    <tbody>
        ...
        if ($resultado->num_rows > 0) {
            while ($row = $resultado->fetch_assoc()) {
                ...
                echo '<td>
                        <a href="consulta_agenda.php?cancelar_id=' . $row['id'] . '">Cancelar</a>
                        <a href="atualizar_agenda.php?id=' . $row['id'] . '">Atualizar</a>
                    </td>';
                echo "</tr>";
            }
        } else {
